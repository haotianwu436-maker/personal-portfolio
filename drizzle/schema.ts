...
export const projects = mysqlTable("projects", {
  ...
  highlights: text("highlights").notNull(), // JSON array stored as string
  impact: text("impact").notNull(),
  learnings: text("learnings").notNull(), // JSON array stored as string
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
});
...
/**
 * Contact submissions table for storing visitor inquiries
 */
