...
echo ""
echo -e "${GREEN}═══════════════════════════════════════════════════════${NC}"
echo -e "${GREEN}🚀 Personal Portfolio 部署脚本${NC}"
echo -e "${GREEN}═══════════════════════════════════════════════════════${NC}"
echo ""
...
# 步骤4: TypeScript检查
echo -e "${YELLOW}[4/6]${NC} 检查TypeScript..."
...
if git diff --quiet && git diff --cached --quiet; then
    ...
    if ! git commit -m "$commit_msg" 2>&1 | tee -a "$DEPLOYMENT_LOG"; then
